/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 60bc55686b2838822f1f035fbc43aaeb)
// Runtime types generated with workerd@1.20250525.0 2025-04-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		GAME: DurableObjectNamespace<import("./workers/app").Game>;
		DB: DurableObjectNamespace<import("./workers/app").DB>;
		ASSETS: Fetcher;
	}
}
